export const projectsData = [
   ...
   // demo: 'https://pavani-DataAnalytics-Platform.netlify.app/',
    ...
    role: 'Frontend Developer',
    code: 'https://github.com/pavanironanki/Healthcare-Dashboard',
    demo: 'https://pavani-healthcare-dashboard.netlify.app/',
...

{
  ...
  longDescription:
    'This project is a single-page website built using React.js, demonstrating React Router, state management, and styled components. It includes a smooth navigation bar, multiple pages/sections, and a responsive layout optimized for both desktop and mobile users. The project was created as a learning exercise to explore React fundamentals, including component structuring, props, hooks, and routing.',
  tools: ['Java', 'Spring Boot', 'React.js', 'MongoDB'],
  role: 'Full Stack Developer',
  code: 'https://github.com/pavanironanki/Landing_Online_Shopping',
  demo: 'https://pavani-Landing_Online_Shopping.netlify.app/',
  image: '\online-landing-page.png',
},

     {
        ...
        code: 'https://github.com/pavanironanki/c2rust',
        demo: '',
    },

    {
        ...
        code: 'https://github.com/pavanironanki/SmartRoundRobin',
        demo: '',
    },
