export const experiences = [
  ...
  },
  {
    ...
    title: "Software Engineer",
    company: "Infosys",
    description:" Responsibities : At Infosys, I built supplier management and complaint-tracking systems using Spring Boot, React.js, and AWS. I implemented secure access with JWT and Spring Security, optimized PostgreSQL performance, and improved deployment pipelines using Jenkins and GitHub Actions. I also developed AWS Lambda serverless functions and ETL workflows, reducing processing time by 50%.",
